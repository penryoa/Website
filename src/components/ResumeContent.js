    ...
    <div>
      ...
      <div id="codeDiv">
        ...
        <p>
          ...
          do the same when appropriate. I have some sample code{" "}
          <a
          ...
          >
            from class projects I've been part of
          </a>
          , as well as code{" "}
          <a
            className="simple_link"
          ...
          >
            from my senior project
          </a>{" "}
          working with a client who has the codebase as open-source. Code{" "}
          <a
            className="simple_link"
            target="_blank"
            rel="noopener noreferrer"
